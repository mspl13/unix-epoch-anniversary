...
// domTimestampGoal.innerHTML = nextTimestampGoal;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__timestamp__ = __webpack_require__(0);


// The DOM timestamp display element
const domTimestamp = document.getElementById("uea-timestamp");

// The DOM timestamp goal display element
document.getElementById("uea-timestamp-goal").innerHTML = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__timestamp__["a" /* getNextEvent */])();

// Refreshes certain DOM elements to ensure a live counter
